module github.com/Project-InitVerse/chain
...
replace (
	github.com/herumi/bls-eth-go-binary => github.com/herumi/bls-eth-go-binary v0.0.0-20210917013441-d37c07cfda4e
	github.com/prysmaticlabs/prysm/v5 => github.com/prysmaticlabs/prysm/v5 v5.3.2
)
