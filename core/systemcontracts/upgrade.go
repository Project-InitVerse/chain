...
import (
	...
	"github.com/Project-InitVerse/chain/core/systemcontracts/bruno"
	"github.com/Project-InitVerse/chain/core/systemcontracts/euler"
	"github.com/Project-InitVerse/chain/core/systemcontracts/feynman"
	feynmanFix "github.com/Project-InitVerse/chain/core/systemcontracts/feynman_fix"
	"github.com/Project-InitVerse/chain/core/systemcontracts/gibbs"
	haberFix "github.com/Project-InitVerse/chain/core/systemcontracts/haber_fix"
	"github.com/Project-InitVerse/chain/core/systemcontracts/kepler"
	"github.com/Project-InitVerse/chain/core/systemcontracts/lorentz"
	"github.com/Project-InitVerse/chain/core/systemcontracts/luban"
	"github.com/Project-InitVerse/chain/core/systemcontracts/maxwell"
	"github.com/Project-InitVerse/chain/core/systemcontracts/mirror"
	"github.com/Project-InitVerse/chain/core/systemcontracts/moran"
	"github.com/Project-InitVerse/chain/core/systemcontracts/niels"
	"github.com/Project-InitVerse/chain/core/systemcontracts/pascal"
	"github.com/Project-InitVerse/chain/core/systemcontracts/planck"
	"github.com/Project-InitVerse/chain/core/systemcontracts/plato"
	"github.com/Project-InitVerse/chain/core/systemcontracts/ramanujan"
...
func init() {
	...
	newtonUpgrade[mainNet] = &Upgrade{
		UpgradeName: "newton",
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(AddressListContract),
				CommitUrl:    "",
				Code:         newton.MainnetAddressListContract,
			},
		},
	}
	newtonUpgrade[testNet] = &Upgrade{
		UpgradeName: "newton",
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(AddressListContract),
				CommitUrl:    "",
				Code:         newton.TestnetAddressListContract,
			},
		},
	}
