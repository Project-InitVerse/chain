...
func (acct *StateAccount) Copy() *StateAccount {
	...
	var lockBalance *uint256.Int
	if acct.Balance != nil {
		balance = new(uint256.Int).Set(acct.Balance)
	}
	if acct.LockBalance != nil {
		lockBalance = new(uint256.Int).Set(acct.LockBalance)
	}
	return &StateAccount{
		Nonce:       acct.Nonce,
		Balance:     balance,
...
func FullAccount(data []byte) (*StateAccount, error) {
	...
	account.Nonce, account.Balance, account.LockBalance = slim.Nonce, slim.Balance, slim.LockBalance
