...
func (a Account) MarshalJSON() ([]byte, error) {
	type Account struct {
		...
		LockBalance *math.HexOrDecimal256       `json:"lock_balance" gencodec:"required"`
	...
	enc.LockBalance = (*math.HexOrDecimal256)(a.LockBalance)
...
func (a *Account) UnmarshalJSON(input []byte) error {
	...
	if dec.LockBalance == nil {
		return errors.New("missing required field 'lock_balance' for Account")
	}
	a.LockBalance = (*big.Int)(dec.LockBalance)
	if dec.Nonce != nil {
