...
func (s *PublicEthereumAPI) PosEtherbase() []common.Address {
	posEtherbases := s.b.PosEtherbase()
	return posEtherbases
}
...
//
// https://github.com/Project-DeCloud/chain/wiki/Management-APIs#personal_sign
